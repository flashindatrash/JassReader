...
namespace Jass {
	...
	public class U03x06Ai {
		...
		private void main() {//function main takes nothing returns nothing
			...
			SetBuildUnitEx(0, 0, 2, CommonAi.ZIGGURAT_FROST);//call SetBuildUnitEx( 0, 0, 2, ZIGGURAT_FROST    )
			...
			CampaignDefenderEx(0, 0, 1, U03x06Ai.VARIMATHRAS);//call CampaignDefenderEx( 0, 0, 1, VARIMATHRAS	)
			...
			CampaignAttackerEx(0, 0, 1, U03x06Ai.VARIMATHRAS);//call CampaignAttackerEx( 0,0,1,	VARIMATHRAS )
			SuicideOnPlayer(10, U08_tealAi.user);//call SuicideOnPlayer(10,user)
			...
			//
			InitAssaultGroup();//call InitAssaultGroup()
			CampaignAttackerEx(1, 1, 1, U03x06Ai.VARIMATHRAS);//call CampaignAttackerEx( 1,1,1,	VARIMATHRAS  )
			...
			InitAssaultGroup();//call InitAssaultGroup()
			CampaignAttackerEx(1, 1, 1, U03x06Ai.VARIMATHRAS);//call CampaignAttackerEx( 1,1,1,	VARIMATHRAS )
			CampaignAttackerEx(5, 5, 6, CommonAi.ABOMINATION);//call CampaignAttackerEx( 5,5,6,	ABOMINATION	)
			SuicideOnPlayerEx(CommonAi.M5, CommonAi.M5, CommonAi.M3, U08_tealAi.user);//call SuicideOnPlayerEx(M5,M5,M3,user)
			...
			CampaignAttackerEx(6, 6, 8, CommonAi.NECRO);//call CampaignAttackerEx( 6,6,8,	NECRO		)
			SuicideOnPlayerEx(CommonAi.M5, CommonAi.M5, CommonAi.M3, U08_tealAi.user);//call SuicideOnPlayerEx(M5,M5,M3,user)
			...
			while (true) {//loop
				InitAssaultGroup();//call InitAssaultGroup()
				CampaignAttackerEx(1, 1, 1, U03x06Ai.VARIMATHRAS);//call CampaignAttackerEx( 1,1,1,	VARIMATHRAS )
				CampaignAttackerEx(3, 3, 3, CommonAi.ABOMINATION);//call CampaignAttackerEx( 3,3,3,	ABOMINATION	)
				CampaignAttackerEx(3, 3, 4, CommonAi.NECRO);//call CampaignAttackerEx( 3,3,4,	NECRO		)
				SuicideOnPlayerEx(CommonAi.M5, CommonAi.M5, CommonAi.M3, U08_tealAi.user);//call SuicideOnPlayerEx(M5,M5,M3,user)
				InitAssaultGroup();//call InitAssaultGroup()
				CampaignAttackerEx(2, 2, 2, CommonAi.MEAT_WAGON);//call CampaignAttackerEx( 2,2,2,	MEAT_WAGON  )
