...
namespace Jass {
	...
	public class N08x12Ai {
		...
		private void main() {//function main takes nothing returns nothing
			...
			SetBuildUpgrEx(1,1,1, BLK_SPHINX);//call SetBuildUpgrEx( 1,1,1, BLK_SPHINX          )
			CampaignDefenderEx(3, 3, 4, ABOMINATION);//call CampaignDefenderEx( 3, 3, 4, ABOMINATION	)
			CampaignDefenderEx(2, 2, 3, BLK_SPHINX);//call CampaignDefenderEx( 2, 2, 3, BLK_SPHINX	)
