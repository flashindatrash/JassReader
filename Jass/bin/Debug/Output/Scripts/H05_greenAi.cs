...
namespace Jass {
	...
	public class H05_greenAi {
		...
		private void main() {//function main takes nothing returns nothing
			...
			SetCaptainHome(ATTACK_CAPTAIN,-3649,-5446);//call SetCaptainHome(ATTACK_CAPTAIN,-3649,-5446)
			...
			//
			InitAssaultGroup();//call InitAssaultGroup()
			CampaignAttackerEx(5,5,8, GHOUL);//call CampaignAttackerEx( 5,5,8, GHOUL       )
