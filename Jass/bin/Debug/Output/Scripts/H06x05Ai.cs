...
namespace Jass {
	...
	public class H06x05Ai {
		...
		private void main() {//function main takes nothing returns nothing
			...
			SetCaptainHome(CommonAi.DEFENSE_CAPTAIN, 3885, 906);//call SetCaptainHome(DEFENSE_CAPTAIN,3885,906)
			...
			CampaignDefenderEx(0, 0, 1, H06x05Ai.SAGRANEL);//call CampaignDefenderEx( 0,0,1, SAGRANEL        )
