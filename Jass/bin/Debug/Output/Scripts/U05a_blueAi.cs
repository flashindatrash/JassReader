...
namespace Jass {
	...
	public class U05a_blueAi {
		...
		private void main() {//function main takes nothing returns nothing
			...
			CampaignAttackerEx(0, 1, 1, CommonAi.SYLVANUS);//call CampaignAttackerEx( 0,1,1, SYLVANUS        )
			SuicideOnPlayerEx(CommonAi.M5, CommonAi.M4, CommonAi.M3, U08_tealAi.user);//call SuicideOnPlayerEx(M5,M4,M3,user)
			//
			InitAssaultGroup();//call InitAssaultGroup()
			...
			SuicideOnPlayerEx(CommonAi.M5, CommonAi.M4, CommonAi.M2, U08_tealAi.user);//call SuicideOnPlayerEx(M5,M4,M2,user)
			//
			InitAssaultGroup();//call InitAssaultGroup()
			...
			CampaignAttackerEx(0, 1, 2, CommonAi.BALLISTA);//call CampaignAttackerEx( 0,1,2, BALLISTA        )
			SuicideOnPlayerEx(CommonAi.M6, CommonAi.M4, CommonAi.M2, U08_tealAi.user);//call SuicideOnPlayerEx(M6,M4,M2,user)
			while (true) {//loop
				//
				InitAssaultGroup();//call InitAssaultGroup()
				...
				CampaignAttackerEx(0, 1, 1, CommonAi.SYLVANUS);//call CampaignAttackerEx( 0,1,1, SYLVANUS     )
				SuicideOnPlayerEx(CommonAi.M6, CommonAi.M4, CommonAi.M3, U08_tealAi.user);//call SuicideOnPlayerEx(M6,M4,M3,user)
			}//endloop
		}//endfunction
