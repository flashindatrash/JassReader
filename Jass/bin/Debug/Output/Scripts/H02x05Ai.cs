...
namespace Jass {
	...
	public class H02x05Ai {
		...
		private void main() {//function main takes nothing returns nothing
			...
			SetBuildUnitEx(1, 1, 1, CommonAi.UNDEAD_MINE);//call SetBuildUnitEx( 1,1,1, UNDEAD_MINE     )
			...
			SetBuildUnitEx(0, 0, 2, CommonAi.UNDEAD_BARGE);//call SetBuildUnitEx( 0,0,2, UNDEAD_BARGE    )
			SetBuildUnitEx(5, 5, 5, CommonAi.ACOLYTE);//call SetBuildUnitEx( 5,5,5, ACOLYTE         )
			...
			//
			InitAssaultGroup();//call InitAssaultGroup()
			CampaignAttackerEx(6, 6, 7, CommonAi.GHOUL);//call CampaignAttackerEx( 6,6,7, GHOUL       )
			...
			//
			InitAssaultGroup();//call InitAssaultGroup()
			CampaignAttackerEx(4, 4, 0, CommonAi.GHOUL);//call CampaignAttackerEx( 4,4,0, GHOUL       )
			...
			InitAssaultGroup();//call InitAssaultGroup()
			CampaignAttackerEx(2, 2, 3, CommonAi.BANSHEE);//call CampaignAttackerEx( 2,2,3, BANSHEE     )
			CampaignAttackerEx(5, 5, 7, CommonAi.CRYPT_FIEND);//call CampaignAttackerEx( 5,5,7, CRYPT_FIEND )
			...
			CampaignAttackerEx(5, 5, 7, CommonAi.NECRO);//call CampaignAttackerEx( 5,5,7, NECRO       )
			CampaignAttackerEx(0, 0, 1, CommonAi.MEAT_WAGON);//call CampaignAttackerEx( 0,0,1, MEAT_WAGON  )
			SuicideOnPlayerEx(CommonAi.M6, CommonAi.M6, CommonAi.M4, U08_tealAi.user);//call SuicideOnPlayerEx(M6,M6,M4,user)
			SetBuildUpgrEx(1, 1, 3, CommonAi.UPG_UNHOLY_STR);//call SetBuildUpgrEx( 1,1,3, UPG_UNHOLY_STR  )
			SetBuildUpgrEx(1, 1, 3, CommonAi.UPG_CR_ATTACK);//call SetBuildUpgrEx( 1,1,3, UPG_CR_ATTACK   )
			...
			while (true) {//loop
				InitAssaultGroup();//call InitAssaultGroup()
				CampaignAttackerEx(0, 0, 3, CommonAi.ABOMINATION);//call CampaignAttackerEx( 0,0,3, ABOMINATION )
				CampaignAttackerEx(5, 5, 0, CommonAi.GHOUL);//call CampaignAttackerEx( 5,5,0, GHOUL       )
				...
				SuicideOnPlayerEx(CommonAi.M6, CommonAi.M6, CommonAi.M4, U08_tealAi.user);//call SuicideOnPlayerEx(M6,M6,M4,user)
				InitAssaultGroup();//call InitAssaultGroup()
				CampaignAttackerEx(6, 6, 0, CommonAi.GHOUL);//call CampaignAttackerEx( 6,6,0, GHOUL       )
