...
namespace Jass {
	...
	public class U05x11Ai {
		...
		private void main() {//function main takes nothing returns nothing
			...
			//
			SuicideOnce(3, 3, 3, CommonAi.GHOUL);//call SuicideOnce( 3, 3, 3, GHOUL        )
			SuicideOnce(1, 1, 1, CommonAi.ABOMINATION);//call SuicideOnce( 1, 1, 1, ABOMINATION  )
			SuicideOnce(2, 2, 2, CommonAi.CRYPT_FIEND);//call SuicideOnce( 2, 2, 2, CRYPT_FIEND  )
			...
			SuicideOnPlayerEx(CommonAi.M5, CommonAi.M5, CommonAi.M5, U08_tealAi.user);//call SuicideOnPlayerEx(M5,M5,M5,user)
			...
			//
			InitAssaultGroup();//call InitAssaultGroup()
			CampaignAttackerEx(6, 6, 6, CommonAi.NECRO);//call CampaignAttackerEx( 6,6,6, NECRO       )
			...
			while (true) {//loop
				InitAssaultGroup();//call InitAssaultGroup()
				CampaignAttackerEx(5, 5, 8, CommonAi.NECRO);//call CampaignAttackerEx( 5,5,8, NECRO       )
				CampaignAttackerEx(3, 3, 5, CommonAi.CRYPT_FIEND);//call CampaignAttackerEx( 3,3,5, CRYPT_FIEND )
				SuicideOnPlayer(U05x11Ai.delay, U08_tealAi.user);//call SuicideOnPlayer(delay,user)
				InitAssaultGroup();//call InitAssaultGroup()
				CampaignAttackerEx(3, 3, 5, CommonAi.CRYPT_FIEND);//call CampaignAttackerEx( 3,3,5, CRYPT_FIEND )
				...
				InitAssaultGroup();//call InitAssaultGroup()
				CampaignAttackerEx(1, 1, 2, CommonAi.MEAT_WAGON);//call CampaignAttackerEx( 1,1,2, MEAT_WAGON  )
				CampaignAttackerEx(5, 5, 6, CommonAi.NECRO);//call CampaignAttackerEx( 5,5,6, NECRO       )
