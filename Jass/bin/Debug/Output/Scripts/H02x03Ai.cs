...
namespace Jass {
	...
	public class H02x03Ai {
		...
		private void main() {//function main takes nothing returns nothing
			...
			CampaignAttackerEx(2, 2, 2, CommonAi.CRYPT_FIEND);//call CampaignAttackerEx( 2,2,2, CRYPT_FIEND )
			...
			while (true) {//loop
				...
				SuicideOnPlayerEx(CommonAi.M6, CommonAi.M6, CommonAi.M4, U08_tealAi.user);//call SuicideOnPlayerEx(M6,M6,M4,user)
				InitAssaultGroup();//call InitAssaultGroup()
				CampaignAttackerEx(5, 5, 8, CommonAi.GHOUL);//call CampaignAttackerEx( 5,5,8, GHOUL       )
