...
namespace Jass {
	...
	public class U05_brownAi {
		...
		private void main() {//function main takes nothing returns nothing
			...
			SetCaptainHome(CommonAi.BOTH_CAPTAINS, -4963, -5986);//call SetCaptainHome(BOTH_CAPTAINS,-4963,-5986)
			...
			CampaignDefenderEx(0, 0, 1, CommonAi.HIGH_ARCHER);//call CampaignDefenderEx( 0,0,1, HIGH_ARCHER		)
