...
namespace Jass {
	...
	public class H05x04Ai {
		...
		private void main() {//function main takes nothing returns nothing
			...
			CampaignDefenderEx(0, 0, 2, CommonAi.CHAOS_GRUNT);//call CampaignDefenderEx( 0,0,2, CHAOS_GRUNT     )
			...
			CampaignDefenderEx(1, 1, 1, CommonAi.CHAOS_GROM);//call CampaignDefenderEx( 1,1,1, CHAOS_GROM		)
			CampaignDefenderEx(1, 1, 3, CommonAi.ORC_DRAGON);//call CampaignDefenderEx( 1,1,3, ORC_DRAGON		)
			...
			CampaignAttackerEx(1, 1, 1, CommonAi.ORC_DRAGON);//call CampaignAttackerEx( 1,1,1, ORC_DRAGON		)
			SuicideOnPlayer(CommonAi.M5, U08_tealAi.user);//call SuicideOnPlayer(M5,user)
			//
			InitAssaultGroup();//call InitAssaultGroup()
			CampaignAttackerEx(3, 3, 5, CommonAi.CHAOS_GRUNT);//call CampaignAttackerEx( 3,3,5, CHAOS_GRUNT		)
			CampaignAttackerEx(1, 1, 1, CommonAi.CHAOS_GROM);//call CampaignAttackerEx( 1,1,1, CHAOS_GROM		)
			...
			//
			InitAssaultGroup();//call InitAssaultGroup()
			CampaignAttackerEx(7, 7, 9, CommonAi.CHAOS_RAIDER);//call CampaignAttackerEx( 7,7,9, CHAOS_RAIDER    )
			SuicideOnPlayerEx(CommonAi.M6, CommonAi.M6, CommonAi.M5, U08_tealAi.user);//call SuicideOnPlayerEx(M6,M6,M5,user)
			...
			//
			InitAssaultGroup();//call InitAssaultGroup()
			CampaignAttackerEx(5, 5, 7, CommonAi.CHAOS_RAIDER);//call CampaignAttackerEx( 5,5,7, CHAOS_RAIDER    )
