...
namespace Jass {
	...
	public class U04b_brownAi {
		...
		private void main() {//function main takes nothing returns nothing
			...
			CampaignDefenderEx(0,0,1, BALLISTA);//call CampaignDefenderEx( 0,0,1, BALLISTA		)
			WaitForSignal();//call WaitForSignal()
			//
			InitAssaultGroup();//call InitAssaultGroup()
			CampaignAttackerEx(1,1,2, HIGH_FOOTMAN);//call CampaignAttackerEx( 1,1,2, HIGH_FOOTMAN	)
			CampaignAttackerEx(1,2,4, HIGH_ARCHER);//call CampaignAttackerEx( 1,2,4, HIGH_ARCHER		)
			SuicideOnPlayerEx(M9,M6,M3,user);//call SuicideOnPlayerEx(M9,M6,M3,user)
			//
			InitAssaultGroup();//call InitAssaultGroup()
			...
			//
			InitAssaultGroup();//call InitAssaultGroup()
			CampaignAttackerEx(0,1,4, HIGH_FOOTMAN);//call CampaignAttackerEx( 0,1,4, HIGH_FOOTMAN	)
			...
			//
			InitAssaultGroup();//call InitAssaultGroup()
			CampaignAttackerEx(2,4,4, HIGH_FOOTMAN);//call CampaignAttackerEx( 2,4,4, HIGH_FOOTMAN	)
			...
			while (true) {//loop
				...
				//
				InitAssaultGroup();//call InitAssaultGroup()
				CampaignAttackerEx(3,4,8, HIGH_FOOTMAN);//call CampaignAttackerEx( 3,4,8, HIGH_FOOTMAN)
				...
				//
				InitAssaultGroup();//call InitAssaultGroup()
				CampaignAttackerEx(2,2,5, HIGH_FOOTMAN);//call CampaignAttackerEx( 2,2,5, HIGH_FOOTMAN)
