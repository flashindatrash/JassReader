...
namespace Jass {
	...
	public class Orc03blueAi {
		...
		private void main() {//function main takes nothing returns nothing
			...
			SetBuildUnit(1, CommonAi.ARCHMAGE);//call SetBuildUnit( 1, ARCHMAGE      )
			SetBuildUnit(1, CommonAi.BARRACKS);//call SetBuildUnit( 1, BARRACKS      )
			SetBuildUnit(2, CommonAi.FOOTMEN);//call SetBuildUnit( 2, FOOTMEN       )
			SetBuildUnit(1, CommonAi.BLACKSMITH);//call SetBuildUnit( 1, BLACKSMITH    )
			SetBuildUnit(2, CommonAi.RIFLEMEN);//call SetBuildUnit( 2, RIFLEMEN      )
			...
			SetAssaultGroup(1, 1, CommonAi.ARCHMAGE);//call SetAssaultGroup( 1, 1, ARCHMAGE    )
			SetAssaultGroup(2, 2, CommonAi.FOOTMEN);//call SetAssaultGroup( 2, 2, FOOTMEN     )
			SetAssaultGroup(2, 2, CommonAi.RIFLEMEN);//call SetAssaultGroup( 2, 2, RIFLEMEN    )
