...
namespace Jass {
	...
	public class U08x09Ai {
		...
		private void main() {//function main takes nothing returns nothing
			...
			SetBuildUnitEx(1, 1, 1, CommonAi.NAGA_CORAL);//call SetBuildUnitEx( 1,1,1, NAGA_CORAL      )
			...
			SetBuildUnitEx(2, 2, 2, CommonAi.NAGA_CORAL);//call SetBuildUnitEx( 2,2,2, NAGA_CORAL      )
			SetBuildUnitEx(1, 1, 2, CommonAi.NAGA_GUARDIAN);//call SetBuildUnitEx( 1,1,2, NAGA_GUARDIAN   )
			AddGuardPost(CommonAi.NAGA_REAVER, -313, -4019);//call AddGuardPost( NAGA_REAVER,         -313, -4019 )
			AddGuardPost(CommonAi.NAGA_REAVER, -579, -4032);//call AddGuardPost( NAGA_REAVER,         -579, -4032 )
			AddGuardPost(CommonAi.NAGA_SIREN, -291, -3774);//call AddGuardPost( NAGA_SIREN,          -291, -3774 )
			AddGuardPost(CommonAi.NAGA_SNAP_DRAGON, -609, -3785);//call AddGuardPost( NAGA_SNAP_DRAGON,    -609, -3785 )
			CampaignDefenderEx(1, 1, 1, CommonAi.NAGA_SIREN);//call CampaignDefenderEx( 1,1,1, NAGA_SIREN          )
			CampaignDefenderEx(2, 2, 2, CommonAi.NAGA_SNAP_DRAGON);//call CampaignDefenderEx( 2,2,2, NAGA_SNAP_DRAGON    )
