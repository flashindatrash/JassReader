...
namespace Jass {
	...
	public class O08_darkgreenAi {
		...
		private void main() {//function main takes nothing returns nothing
			...
			SuicideOnPlayer(M3,jaina);//call SuicideOnPlayer(M3,jaina)
			//
			InitAssaultGroup();//call InitAssaultGroup()
			...
			SuicideOnPlayerEx(M8,M8,M6,jaina);//call SuicideOnPlayerEx(M8,M8,M6,jaina)
			//
			InitAssaultGroup();//call InitAssaultGroup()
			...
			//
			InitAssaultGroup();//call InitAssaultGroup()
			CampaignAttackerEx(6,6,7, CHAOS_RAIDER);//call CampaignAttackerEx( 6,6,7, CHAOS_RAIDER    )
			...
			//
			InitAssaultGroup();//call InitAssaultGroup()
			CampaignAttackerEx(7,7,8, CHAOS_RAIDER);//call CampaignAttackerEx( 7,7,8, CHAOS_RAIDER    )
			CampaignAttackerEx(1,1,1, CHAOS_KODO);//call CampaignAttackerEx( 1,1,1, CHAOS_KODO		)
			CampaignAttackerEx(1,1,2, CHAOS_WARLOCK);//call CampaignAttackerEx( 1,1,2, CHAOS_WARLOCK   )
			SuicideOnPlayerEx(M8,M8,M6,jaina);//call SuicideOnPlayerEx(M8,M8,M6,jaina)
			//
			...
			while (true) {//loop
				...
				//
				InitAssaultGroup();//call InitAssaultGroup()
				CampaignAttackerEx(8,8,9, CHAOS_RAIDER);//call CampaignAttackerEx( 8,8,9, CHAOS_RAIDER  )
				SuicideOnPlayerEx(M8,M8,M6,jaina);//call SuicideOnPlayerEx(M8,M8,M6,jaina)
				//
				InitAssaultGroup();//call InitAssaultGroup()
				CampaignAttackerEx(4,4,7, CHAOS_GRUNT);//call CampaignAttackerEx( 4,4,7, CHAOS_GRUNT    )
