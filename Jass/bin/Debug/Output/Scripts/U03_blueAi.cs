...
namespace Jass {
	...
	public class U03_blueAi {
		...
		private void main() {//function main takes nothing returns nothing
			...
			SetCaptainHome(CommonAi.DEFENSE_CAPTAIN, 4861, -3994);//call SetCaptainHome(DEFENSE_CAPTAIN,4861,-3994)
			...
			while (true) {//loop
				...
				CampaignAttackerEx(3, 3, 7, CommonAi.HIGH_ARCHER);//call CampaignAttackerEx( 3,3,7, HIGH_ARCHER  )
				CampaignAttackerEx(1, 1, 2, CommonAi.PRIEST);//call CampaignAttackerEx( 1,1,2, PRIEST       )
				CampaignAttackerEx(0, 0, 1, CommonAi.SORCERESS);//call CampaignAttackerEx( 0,0,1, SORCERESS    )
				CampaignAttackerEx(1, 1, 1, CommonAi.SYLVANUS);//call CampaignAttackerEx( 1,1,1, SYLVANUS     )
				SuicideOnPlayerEx(CommonAi.M5, CommonAi.M5, CommonAi.M4, U08_tealAi.user);//call SuicideOnPlayerEx(M5,M5,M4,user)
				//
				InitAssaultGroup();//call InitAssaultGroup()
				CampaignAttackerEx(2, 2, 8, CommonAi.HIGH_SWORDMAN);//call CampaignAttackerEx( 2,2,8, HIGH_SWORDMAN)
				CampaignAttackerEx(2, 2, 2, CommonAi.HIGH_ARCHER);//call CampaignAttackerEx( 2,2,2, HIGH_ARCHER  )
				CampaignAttackerEx(2, 2, 4, CommonAi.PRIEST);//call CampaignAttackerEx( 2,2,4, PRIEST       )
				CampaignAttackerEx(1, 1, 1, CommonAi.SORCERESS);//call CampaignAttackerEx( 1,1,1, SORCERESS    )
				CampaignAttackerEx(1, 1, 2, CommonAi.BALLISTA);//call CampaignAttackerEx( 1,1,2, BALLISTA     )
				SuicideOnPlayerEx(CommonAi.M5, CommonAi.M5, CommonAi.M4, U08_tealAi.user);//call SuicideOnPlayerEx(M5,M5,M4,user)
				//
				InitAssaultGroup();//call InitAssaultGroup()
				CampaignAttackerEx(1, 1, 5, CommonAi.HIGH_SWORDMAN);//call CampaignAttackerEx( 1,1,5, HIGH_SWORDMAN)
				CampaignAttackerEx(3, 3, 3, CommonAi.HIGH_ARCHER);//call CampaignAttackerEx( 3,3,3, HIGH_ARCHER  )
				CampaignAttackerEx(0, 0, 2, CommonAi.PRIEST);//call CampaignAttackerEx( 0,0,2, PRIEST       )
				CampaignAttackerEx(1, 1, 4, CommonAi.SORCERESS);//call CampaignAttackerEx( 1,1,4, SORCERESS    )
				CampaignAttackerEx(1, 1, 1, CommonAi.SYLVANUS);//call CampaignAttackerEx( 1,1,1, SYLVANUS     )
				SuicideOnPlayerEx(CommonAi.M5, CommonAi.M5, CommonAi.M4, U08_tealAi.user);//call SuicideOnPlayerEx(M5,M5,M4,user)
			}//endloop
		}//endfunction
