...
namespace Jass {
	...
	public class Orc03warsongAi {
		...
		private void main() {//function main takes nothing returns nothing
			...
			SetBuildUnit(1, BLADE_MASTER);//call SetBuildUnit( 1, BLADE_MASTER  )
			SetBuildUnit(1, ORC_BARRACKS);//call SetBuildUnit( 1, ORC_BARRACKS  )
			SetBuildUnit(4, GRUNT);//call SetBuildUnit( 4, GRUNT         )
			SetBuildUnit(3, PEON);//call SetBuildUnit( 3, PEON          )
			SetAssaultGroup(1, 1, BLADE_MASTER);//call SetAssaultGroup( 1, 1, BLADE_MASTER   )
			SetAssaultGroup(4, 4, GRUNT);//call SetAssaultGroup( 4, 4, GRUNT          )
