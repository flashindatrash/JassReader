...
namespace Jass {
	...
	public class U08x05Ai {
		...
		private void main() {//function main takes nothing returns nothing
			...
			SetCaptainHome(BOTH_CAPTAINS,3300,5700);//call SetCaptainHome(BOTH_CAPTAINS,3300,5700)
			...
			//
			//
			CampaignDefenderEx(2,2,2, NAGA_ROYAL);//call CampaignDefenderEx( 2,2,2, NAGA_ROYAL          )
			CampaignDefenderEx(8,8,8, NAGA_SNAP_DRAGON);//call CampaignDefenderEx( 8,8,8, NAGA_SNAP_DRAGON    )
			CampaignDefenderEx(3,3,3, NAGA_SIREN);//call CampaignDefenderEx( 3,3,3, NAGA_SIREN          )
			CampaignDefenderEx(8,8,8, NAGA_COUATL);//call CampaignDefenderEx( 8,8,8, NAGA_COUATL         )
