...
namespace Jass {
	...
	public class Human05Pld {

		private void PreloadFiles() {//function PreloadFiles takes nothing returns nothing
			Preload("units\\human\\Arthas\\Arthas.mdx");//call Preload( "units\\human\\Arthas\\Arthas.mdx" )
			Preload("Textures\\Arthas.blp");//call Preload( "Textures\\Arthas.blp" )
			Preload("Textures\\RibbonBlur1.blp");//call Preload( "Textures\\RibbonBlur1.blp" )
			Preload("ReplaceableTextures\\CommandButtons\\BTNArthas.blp");//call Preload( "ReplaceableTextures\\CommandButtons\\BTNArthas.blp" )
			Preload("ReplaceableTextures\\CommandButtonsDisabled\\DISBTNArthas.blp");//call Preload( "ReplaceableTextures\\CommandButtonsDisabled\\DISBTNArthas.blp" )
			...
			Preload("units\\human\\Jaina\\Jaina.mdx");//call Preload( "units\\human\\Jaina\\Jaina.mdx" )
			Preload("units\\Human\\Jaina\\Jaina.blp");//call Preload( "units\\Human\\Jaina\\Jaina.blp" )
			Preload("ReplaceableTextures\\CommandButtons\\BTNJaina.blp");//call Preload( "ReplaceableTextures\\CommandButtons\\BTNJaina.blp" )
			Preload("ReplaceableTextures\\CommandButtonsDisabled\\DISBTNJaina.blp");//call Preload( "ReplaceableTextures\\CommandButtonsDisabled\\DISBTNJaina.blp" )
			...
			Preload("Sound\\Dialogue\\HumanCampaign\\Human05\\H05Jaina01.mp3");//call Preload( "Sound\\Dialogue\\HumanCampaign\\Human05\\H05Jaina01.mp3" )
			Preload("Sound\\Dialogue\\HumanCampaign\\Human05\\H05Arthas02.mp3");//call Preload( "Sound\\Dialogue\\HumanCampaign\\Human05\\H05Arthas02.mp3" )
			Preload("Sound\\Dialogue\\HumanCampaign\\Human05\\H05Footman03.mp3");//call Preload( "Sound\\Dialogue\\HumanCampaign\\Human05\\H05Footman03.mp3" )
			Preload("Sound\\Dialogue\\HumanCampaign\\Human05\\H05Footman04.mp3");//call Preload( "Sound\\Dialogue\\HumanCampaign\\Human05\\H05Footman04.mp3" )
			Preload("Sound\\Dialogue\\HumanCampaign\\Human05\\H05Arthas05.mp3");//call Preload( "Sound\\Dialogue\\HumanCampaign\\Human05\\H05Arthas05.mp3" )
			Preload("Sound\\Dialogue\\HumanCampaign\\Human05\\H05Jaina06.mp3");//call Preload( "Sound\\Dialogue\\HumanCampaign\\Human05\\H05Jaina06.mp3" )
			Preload("Sound\\Dialogue\\HumanCampaign\\Human05\\H05Arthas07.mp3");//call Preload( "Sound\\Dialogue\\HumanCampaign\\Human05\\H05Arthas07.mp3" )
			...
			Preload("ReplaceableTextures\\Splats\\TeleportTarget.blp");//call Preload( "ReplaceableTextures\\Splats\\TeleportTarget.blp" )
			...
			Preload("Sound\\Dialogue\\HumanCampaign\\Human05\\H05Arthas08.mp3");//call Preload( "Sound\\Dialogue\\HumanCampaign\\Human05\\H05Arthas08.mp3" )
			Preload("Sound\\Dialogue\\HumanCampaign\\Human05\\H05Footman09.mp3");//call Preload( "Sound\\Dialogue\\HumanCampaign\\Human05\\H05Footman09.mp3" )
			Preload("Sound\\Dialogue\\HumanCampaign\\Human05\\H05Arthas10.mp3");//call Preload( "Sound\\Dialogue\\HumanCampaign\\Human05\\H05Arthas10.mp3" )
			Preload("units\\undead\\HeroDreadLord\\HeroDreadLord.mdx");//call Preload( "units\\undead\\HeroDreadLord\\HeroDreadLord.mdx" )
			Preload("units\\Undead\\HeroDreadLord\\HeroDreadlord.blp");//call Preload( "units\\Undead\\HeroDreadLord\\HeroDreadlord.blp" )
			Preload("Textures\\Flare.blp");//call Preload( "Textures\\Flare.blp" )
			Preload("Textures\\Dust5ABlack.blp");//call Preload( "Textures\\Dust5ABlack.blp" )
			Preload("ReplaceableTextures\\CommandButtons\\BTNTemp.blp");//call Preload( "ReplaceableTextures\\CommandButtons\\BTNTemp.blp" )
			Preload("ReplaceableTextures\\CommandButtonsDisabled\\DISBTNTemp.blp");//call Preload( "ReplaceableTextures\\CommandButtonsDisabled\\DISBTNTemp.blp" )
			Preload("Abilities\\Spells\\Undead\\Sleep\\SleepTarget.mdx");//call Preload( "Abilities\\Spells\\Undead\\Sleep\\SleepTarget.mdx" )
			Preload("ReplaceableTextures\\Splats\\AuraRune9b.blp");//call Preload( "ReplaceableTextures\\Splats\\AuraRune9b.blp" )
			Preload("Sound\\Dialogue\\HumanCampaign\\Human05\\H05Arthas11.mp3");//call Preload( "Sound\\Dialogue\\HumanCampaign\\Human05\\H05Arthas11.mp3" )
			Preload("Abilities\\Spells\\Demon\\DarkConversion\\ZombifyTarget.mdx");//call Preload( "Abilities\\Spells\\Demon\\DarkConversion\\ZombifyTarget.mdx" )
			Preload("units\\creeps\\Zombie\\Zombie.mdx");//call Preload( "units\\creeps\\Zombie\\Zombie.mdx" )
			Preload("units\\Creeps\\Zombie\\ZombieA.blp");//call Preload( "units\\Creeps\\Zombie\\ZombieA.blp" )
			Preload("Abilities\\Weapons\\Rifle\\RifleImpact.mdx");//call Preload( "Abilities\\Weapons\\Rifle\\RifleImpact.mdx" )
			Preload("Abilities\\Weapons\\PriestMissile\\PriestMissile.mdx");//call Preload( "Abilities\\Weapons\\PriestMissile\\PriestMissile.mdx" )
			...
			Preload("Objects\\Spawnmodels\\Human\\HumanBlood\\HumanBloodRifleman.mdx");//call Preload( "Objects\\Spawnmodels\\Human\\HumanBlood\\HumanBloodRifleman.mdx" )
			Preload("Abilities\\Spells\\Human\\Heal\\HealTarget.mdx");//call Preload( "Abilities\\Spells\\Human\\Heal\\HealTarget.mdx" )
			...
			Preload("ReplaceableTextures\\PassiveButtons\\PASBTNDevotion.blp");//call Preload( "ReplaceableTextures\\PassiveButtons\\PASBTNDevotion.blp" )
			Preload("ReplaceableTextures\\CommandButtonsDisabled\\DISPASBTNDevotion.blp");//call Preload( "ReplaceableTextures\\CommandButtonsDisabled\\DISPASBTNDevotion.blp" )
			...
			Preload("ReplaceableTextures\\CommandButtons\\BTNHolyBolt.blp");//call Preload( "ReplaceableTextures\\CommandButtons\\BTNHolyBolt.blp" )
			Preload("ReplaceableTextures\\CommandButtonsDisabled\\DISBTNHolyBolt.blp");//call Preload( "ReplaceableTextures\\CommandButtonsDisabled\\DISBTNHolyBolt.blp" )
			Preload("ReplaceableTextures\\CommandButtons\\BTNDivineIntervention.blp");//call Preload( "ReplaceableTextures\\CommandButtons\\BTNDivineIntervention.blp" )
			Preload("ReplaceableTextures\\CommandButtonsDisabled\\DISBTNDivineIntervention.blp");//call Preload( "ReplaceableTextures\\CommandButtonsDisabled\\DISBTNDivineIntervention.blp" )
			...
			Preload("ReplaceableTextures\\CommandButtons\\BTNDevotion.blp");//call Preload( "ReplaceableTextures\\CommandButtons\\BTNDevotion.blp" )
			Preload("UI\\Widgets\\Console\\Human\\infocard-heroattributes-str.blp");//call Preload( "UI\\Widgets\\Console\\Human\\infocard-heroattributes-str.blp" )
