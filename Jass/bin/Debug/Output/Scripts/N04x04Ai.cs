...
namespace Jass {
	...
	public class N04x04Ai {
		...
		private void main() {//function main takes nothing returns nothing
			...
			SetCaptainHome(CommonAi.ATTACK_CAPTAIN, 3428, 4113);//call SetCaptainHome(ATTACK_CAPTAIN,3428,4113)
			...
			CampaignDefenderEx(2, 2, 3, CommonAi.NAGA_REAVER);//call CampaignDefenderEx( 2,2,3, NAGA_REAVER     )
			CampaignDefenderEx(1, 1, 1, CommonAi.NAGA_VASHJ);//call CampaignDefenderEx( 1,1,1, NAGA_VASHJ      )
			...
			//
			InitAssaultGroup();//call InitAssaultGroup()
			CampaignAttackerEx(2, 2, 5, CommonAi.NAGA_REAVER);//call CampaignAttackerEx( 2, 2, 5, NAGA_REAVER       )
			CampaignAttackerEx(3, 3, 4, CommonAi.NAGA_SNAP_DRAGON);//call CampaignAttackerEx( 3, 3, 4, NAGA_SNAP_DRAGON  )
			CampaignAttackerEx(0, 0, 1, CommonAi.NAGA_MYRMIDON);//call CampaignAttackerEx( 0, 0, 1, NAGA_MYRMIDON		)
			...
			CampaignAttackerEx(1, 1, 1, CommonAi.NAGA_VASHJ);//call CampaignAttackerEx( 1, 1, 1, NAGA_VASHJ        )
			CampaignAttackerEx(1, 1, 1, CommonAi.NAGA_TURTLE);//call CampaignAttackerEx( 1, 1, 1, NAGA_TURTLE       )
			SuicideOnPlayerEx(CommonAi.M5, CommonAi.M5, CommonAi.M4, U08_tealAi.user);//call SuicideOnPlayerEx(M5,M5,M4,user)
			//
			InitAssaultGroup();//call InitAssaultGroup()
			CampaignAttackerEx(2, 2, 3, CommonAi.NAGA_MYRMIDON);//call CampaignAttackerEx( 2, 2, 3, NAGA_MYRMIDON     )
			...
			while (true) {//loop
				InitAssaultGroup();//call InitAssaultGroup()
				CampaignAttackerEx(1, 1, 1, CommonAi.NAGA_VASHJ);//call CampaignAttackerEx( 1, 1, 1, NAGA_VASHJ        )
				CampaignAttackerEx(2, 2, 2, CommonAi.NAGA_MYRMIDON);//call CampaignAttackerEx( 2, 2, 2, NAGA_MYRMIDON     )
				...
				CampaignAttackerEx(4, 4, 5, CommonAi.NAGA_MYRMIDON);//call CampaignAttackerEx( 4, 4, 5, NAGA_MYRMIDON     )
				CampaignAttackerEx(2, 2, 3, CommonAi.NAGA_SNAP_DRAGON);//call CampaignAttackerEx( 2, 2, 3, NAGA_SNAP_DRAGON  )
				SuicideOnPlayerEx(CommonAi.M5, CommonAi.M5, CommonAi.M4, U08_tealAi.user);//call SuicideOnPlayerEx(M5,M5,M4,user)
			}//endloop
		}//endfunction
