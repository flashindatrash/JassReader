...
namespace Jass {
	...
	public class U08x08Ai {
		...
		private void main() {//function main takes nothing returns nothing
			...
			AddGuardPost(CommonAi.NAGA_COUATL, 2485, -1088);//call AddGuardPost( NAGA_COUATL,         2485, -1088 )
			AddGuardPost(CommonAi.NAGA_COUATL, 2502, -1311);//call AddGuardPost( NAGA_COUATL,         2502, -1311 )
			AddGuardPost(CommonAi.NAGA_SIREN, 2755, -875);//call AddGuardPost( NAGA_SIREN,          2755,  -875 )
			AddGuardPost(CommonAi.NAGA_SNAP_DRAGON, 2746, -1173);//call AddGuardPost( NAGA_SNAP_DRAGON,    2746, -1173 )
			...
			CampaignDefenderEx(3, 3, 3, CommonAi.NAGA_COUATL);//call CampaignDefenderEx( 3,3,3, NAGA_COUATL         )
