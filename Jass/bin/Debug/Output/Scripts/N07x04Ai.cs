...
namespace Jass {
	...
	public class N07x04Ai {
		...
		private void main() {//function main takes nothing returns nothing
			...
			CampaignDefenderEx(0, 0, 1, ILLIDAN);//call CampaignDefenderEx( 0, 0, 1, ILLIDAN       )
			...
			SuicideOnPlayerEx(M4,M4,M1,targ);//call SuicideOnPlayerEx(M4,M4,M1,targ)
			//
			InitAssaultGroup();//call InitAssaultGroup()
			...
			SuicideOnPlayerEx(M5,M5,M3,targ);//call SuicideOnPlayerEx(M5,M5,M3,targ)
			...
			CampaignAttackerEx(1, 1, 3, NAGA_COUATL);//call CampaignAttackerEx( 1, 1, 3, NAGA_COUATL       )
			CampaignAttackerEx(0, 0, 1, NAGA_VASHJ);//call CampaignAttackerEx( 0, 0, 1, NAGA_VASHJ        )
			SuicideOnPlayerEx(M5,M5,M3,targ);//call SuicideOnPlayerEx(M5,M5,M3,targ)
			//
			InitAssaultGroup();//call InitAssaultGroup()
			CampaignAttackerEx(2, 2, 4, NAGA_MYRMIDON);//call CampaignAttackerEx( 2, 2, 4, NAGA_MYRMIDON     )
			CampaignAttackerEx(4, 4, 6, NAGA_DRAGON);//call CampaignAttackerEx( 4, 4, 6, NAGA_DRAGON       )
			CampaignAttackerEx(1, 1, 1, ILLIDAN);//call CampaignAttackerEx( 1, 1, 1, ILLIDAN           )
			SuicideOnPlayerEx(M5,M5,M3,targ);//call SuicideOnPlayerEx(M5,M5,M3,targ)
			SetBuildUpgrEx(2,2,3, UPG_NAGA_ATTACK);//call SetBuildUpgrEx( 2,2,3, UPG_NAGA_ATTACK     )
			SetBuildUpgrEx(2,2,3, UPG_NAGA_ARMOR);//call SetBuildUpgrEx( 2,2,3, UPG_NAGA_ARMOR      )
			//
			while (true) {//loop
				InitAssaultGroup();//call InitAssaultGroup()
				CampaignAttackerEx(1, 1, 3, NAGA_TURTLE);//call CampaignAttackerEx( 1, 1, 3, NAGA_TURTLE       )
				CampaignAttackerEx(2, 2, 5, NAGA_COUATL);//call CampaignAttackerEx( 2, 2, 5, NAGA_COUATL       )
				CampaignAttackerEx(4, 4, 7, NAGA_SIREN);//call CampaignAttackerEx( 4, 4, 7, NAGA_SIREN        )
				CampaignAttackerEx(1, 1, 1, NAGA_VASHJ);//call CampaignAttackerEx( 1, 1, 1, NAGA_VASHJ        )
				SuicideOnPlayerEx(M5,M5,M3,targ);//call SuicideOnPlayerEx(M5,M5,M3,targ)
				InitAssaultGroup();//call InitAssaultGroup()
				CampaignAttackerEx(2, 2, 4, NAGA_MYRMIDON);//call CampaignAttackerEx( 2, 2, 4, NAGA_MYRMIDON     )
				CampaignAttackerEx(2, 2, 4, NAGA_DRAGON);//call CampaignAttackerEx( 2, 2, 4, NAGA_DRAGON       )
				CampaignAttackerEx(1, 1, 3, NAGA_TURTLE);//call CampaignAttackerEx( 1, 1, 3, NAGA_TURTLE       )
				CampaignAttackerEx(1, 1, 1, ILLIDAN);//call CampaignAttackerEx( 1, 1, 1, ILLIDAN           )
				SuicideOnPlayerEx(M5,M5,M3,targ);//call SuicideOnPlayerEx(M5,M5,M3,targ)
				InitAssaultGroup();//call InitAssaultGroup()
				CampaignAttackerEx(1, 1, 8, NAGA_COUATL);//call CampaignAttackerEx( 1, 1, 8, NAGA_COUATL      )
				SuicideOnPlayerEx(M5,M5,M3,targ);//call SuicideOnPlayerEx(M5,M5,M3,targ)
				InitAssaultGroup();//call InitAssaultGroup()
				CampaignAttackerEx(1, 1, 3, NAGA_TURTLE);//call CampaignAttackerEx( 1, 1, 3, NAGA_TURTLE       )
				CampaignAttackerEx(2, 2, 5, NAGA_MYRMIDON);//call CampaignAttackerEx( 2, 2, 5, NAGA_MYRMIDON     )
				CampaignAttackerEx(3, 3, 5, NAGA_SIREN);//call CampaignAttackerEx( 3, 3, 5, NAGA_SIREN        )
				CampaignAttackerEx(1, 1, 1, ILLIDAN);//call CampaignAttackerEx( 1, 1, 1, ILLIDAN           )
				SuicideOnPlayerEx(M5,M5,M3,targ);//call SuicideOnPlayerEx(M5,M5,M3,targ)
			}//endloop
		}//endfunction
