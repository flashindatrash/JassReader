...
namespace Jass {
	...
	public class U08x10Ai {
		...
		private void main() {//function main takes nothing returns nothing
			...
			SetBuildUnitEx(2, 2, 3, CommonAi.NAGA_GUARDIAN);//call SetBuildUnitEx( 2,2,3, NAGA_GUARDIAN   )
			AddGuardPost(CommonAi.NAGA_MYRMIDON, -3713, -953);//call AddGuardPost( NAGA_MYRMIDON,   -3713,  -953 )
			AddGuardPost(CommonAi.NAGA_COUATL, -3445, -1118);//call AddGuardPost( NAGA_COUATL,     -3445, -1118 )
			AddGuardPost(CommonAi.NAGA_SIREN, -3458, -1252);//call AddGuardPost( NAGA_SIREN,      -3458, -1252 )
			AddGuardPost(CommonAi.NAGA_REAVER, -3681, -1230);//call AddGuardPost( NAGA_REAVER,     -3681, -1230 )
			CampaignDefenderEx(1, 1, 3, CommonAi.NAGA_MYRMIDON);//call CampaignDefenderEx( 1,1,3, NAGA_MYRMIDON       )
			CampaignDefenderEx(1, 1, 2, CommonAi.NAGA_SIREN);//call CampaignDefenderEx( 1,1,2, NAGA_SIREN          )
			CampaignDefenderEx(2, 2, 4, CommonAi.NAGA_REAVER);//call CampaignDefenderEx( 2,2,4, NAGA_REAVER         )
