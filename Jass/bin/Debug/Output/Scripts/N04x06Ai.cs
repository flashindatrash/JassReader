...
namespace Jass {
	...
	public class N04x06Ai {
		...
		private void main() {//function main takes nothing returns nothing
			...
			CampaignDefenderEx(3, 3, 4, CommonAi.NAGA_COUATL);//call CampaignDefenderEx( 3,3,4, NAGA_COUATL     )
			CampaignDefenderEx(1, 1, 1, CommonAi.NAGA_REAVER);//call CampaignDefenderEx( 1,1,1, NAGA_REAVER     )
			//
			InitAssaultGroup();//call InitAssaultGroup()
			CampaignAttackerEx(6, 6, 6, CommonAi.NAGA_REAVER);//call CampaignAttackerEx( 6, 6, 6, NAGA_REAVER   )
			...
			//
			InitAssaultGroup();//call InitAssaultGroup()
			CampaignAttackerEx(4, 4, 6, CommonAi.NAGA_COUATL);//call CampaignAttackerEx( 4, 4, 6, NAGA_COUATL   )
