...
namespace Jass {
	...
	public class U04_darkgreenAi {
		...
		private void main() {//function main takes nothing returns nothing
			...
			CampaignDefenderEx(1, 1, 1, CommonAi.DRAGON_HAWK);//call CampaignDefenderEx( 1,1,1, DRAGON_HAWK		)
			...
			//
			InitAssaultGroup();//call InitAssaultGroup()
			CampaignAttackerEx(3, 3, 4, CommonAi.DRAGON_HAWK);//call CampaignAttackerEx( 3,3,4, DRAGON_HAWK		)
			SuicideOnPlayerEx(CommonAi.M7, CommonAi.M7, CommonAi.M5, U08_tealAi.user);//call SuicideOnPlayerEx(M7,M7,M5,user)
			//
			InitAssaultGroup();//call InitAssaultGroup()
			CampaignAttackerEx(1, 1, 4, CommonAi.DRAGON_HAWK);//call CampaignAttackerEx( 1,1,4, DRAGON_HAWK		)
			...
			//
			InitAssaultGroup();//call InitAssaultGroup()
			CampaignAttackerEx(0, 0, 4, CommonAi.HIGH_SWORDMAN);//call CampaignAttackerEx( 0,0,4, HIGH_SWORDMAN	)
			CampaignAttackerEx(3, 3, 4, CommonAi.HIGH_ARCHER);//call CampaignAttackerEx( 3,3,4, HIGH_ARCHER		)
			CampaignAttackerEx(3, 3, 3, CommonAi.DRAGON_HAWK);//call CampaignAttackerEx( 3,3,3, DRAGON_HAWK		)
			SuicideOnPlayerEx(CommonAi.M8, CommonAi.M8, CommonAi.M5, U08_tealAi.user);//call SuicideOnPlayerEx(M8,M8,M5,user)
			while (true) {//loop
				//
				InitAssaultGroup();//call InitAssaultGroup()
				...
				CampaignAttackerEx(2, 2, 6, CommonAi.DRAGON_HAWK);//call CampaignAttackerEx( 2,2,6, DRAGON_HAWK		)
