...
namespace Jass {
	...
	public class O06_blueAi {
		...
		private void main() {//function main takes nothing returns nothing
			...
			CampaignDefenderEx(1,1,1, GRYPHON);//call CampaignDefenderEx( 1,1,1, GRYPHON     )
			...
			CampaignDefenderEx(0,0,1, MTN_KING);//call CampaignDefenderEx( 0,0,1, MTN_KING    )
			...
			while (true) {//loop
				//
				InitAssaultGroup();//call InitAssaultGroup()
				CampaignAttackerEx(6,6,5, RIFLEMAN);//call CampaignAttackerEx( 6,6,5, RIFLEMAN    )
