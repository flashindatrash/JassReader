...
namespace Jass {
	...
	public class U06x06Ai {
		...
		private void main() {//function main takes nothing returns nothing
			...
			//
			InitAssaultGroup();//call InitAssaultGroup()
			CampaignAttackerEx(10, 10, 14, CommonAi.GHOUL);//call CampaignAttackerEx( 10,10,14,  GHOUL   )
			SuicideOnPlayerEx(CommonAi.M7, CommonAi.M7, CommonAi.M6, U08_tealAi.user);//call SuicideOnPlayerEx(M7,M7,M6,user)
			...
			while (true) {//loop
				...
				InitAssaultGroup();//call InitAssaultGroup()
				InitAssaultGroup();//call InitAssaultGroup()
				CampaignAttackerEx(7, 7, 9, CommonAi.GARGOYLE);//call CampaignAttackerEx( 7,7,9, GARGOYLE    )
