...
namespace Jass {
	...
	public class N05x03Ai {
		...
		private void main() {//function main takes nothing returns nothing
			...
			SuicideOnPlayerEx(30,30,30,user);//call SuicideOnPlayerEx(30,30,30,user)
			//
			InitAssaultGroup();//call InitAssaultGroup()
			CampaignAttackerEx(4, 4, 6, NAGA_REAVER);//call CampaignAttackerEx( 4, 4, 6, NAGA_REAVER	)
			CampaignAttackerEx(1, 1, 2, NAGA_MYRMIDON);//call CampaignAttackerEx( 1, 1, 2, NAGA_MYRMIDON )
			...
			//
			InitAssaultGroup();//call InitAssaultGroup()
			CampaignAttackerEx(1, 1, 4, NAGA_MYRMIDON);//call CampaignAttackerEx( 1, 1, 4, NAGA_MYRMIDON	)
			CampaignAttackerEx(2, 2, 3, NAGA_DRAGON);//call CampaignAttackerEx( 2, 2, 3, NAGA_DRAGON   )
			SuicideOnPlayerEx(M4,M4,M3,user);//call SuicideOnPlayerEx(M4,M4,M3,user)
		}//endfunction
