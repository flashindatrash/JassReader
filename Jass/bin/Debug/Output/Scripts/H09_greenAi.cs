...
namespace Jass {
	...
	public class H09_greenAi {
		...
		private void after_sword() {//function after_sword takes nothing returns nothing
			...
			SetBuildUpgrEx(0, 0, 3, CommonAi.UPG_UNHOLY_STR);//call SetBuildUpgrEx( 0,0,3, UPG_UNHOLY_STR    )
			SetBuildUpgrEx(0, 0, 3, CommonAi.UPG_UNHOLY_ARMOR);//call SetBuildUpgrEx( 0,0,3, UPG_UNHOLY_ARMOR  )
			SetBuildUpgrEx(0, 0, 3, CommonAi.UPG_CR_ATTACK);//call SetBuildUpgrEx( 0,0,3, UPG_CR_ATTACK     )
			SetBuildUpgrEx(0, 0, 3, CommonAi.UPG_CR_ARMOR);//call SetBuildUpgrEx( 0,0,3, UPG_CR_ARMOR      )
			while (true) {//loop
				//
				InitAssaultGroup();//call InitAssaultGroup()
				CampaignAttackerEx(1, 1, 1, CommonAi.MALGANIS);//call CampaignAttackerEx( 1,1,1, MALGANIS     )
				CampaignAttackerEx(2, 2, 5, CommonAi.CRYPT_FIEND);//call CampaignAttackerEx( 2,2,5, CRYPT_FIEND  )
				...
				CampaignAttackerEx(1, 1, 4, CommonAi.MEAT_WAGON);//call CampaignAttackerEx( 1,1,4, MEAT_WAGON   )
				SuicideOnPlayerEx(CommonAi.M8, CommonAi.M8, CommonAi.M8, U08_tealAi.user);//call SuicideOnPlayerEx(M8,M8,M8,user)
				InitAssaultGroup();//call InitAssaultGroup()
				CampaignAttackerEx(0, 0, 1, CommonAi.MALGANIS);//call CampaignAttackerEx( 0,0,1, MALGANIS     )
				CampaignAttackerEx(0, 0, 2, CommonAi.ABOMINATION);//call CampaignAttackerEx( 0,0,2, ABOMINATION  )
				CampaignAttackerEx(2, 2, 8, CommonAi.GARGOYLE);//call CampaignAttackerEx( 2,2,8, GARGOYLE     )
				...
				CampaignAttackerEx(1, 1, 3, CommonAi.MEAT_WAGON);//call CampaignAttackerEx( 1,1,3, MEAT_WAGON   )
				CampaignAttackerEx(0, 0, 4, CommonAi.CRYPT_FIEND);//call CampaignAttackerEx( 0,0,4, CRYPT_FIEND  )
				CampaignAttackerEx(0, 0, 3, CommonAi.NECRO);//call CampaignAttackerEx( 0,0,3, NECRO        )
				CampaignAttackerEx(2, 2, 6, CommonAi.GHOUL);//call CampaignAttackerEx( 2,2,6, GHOUL        )
				SuicideOnPlayerEx(CommonAi.M8, CommonAi.M8, CommonAi.M8, U08_tealAi.user);//call SuicideOnPlayerEx(M8,M8,M8,user)
				InitAssaultGroup();//call InitAssaultGroup()
				CampaignAttackerEx(0, 0, 1, CommonAi.MALGANIS);//call CampaignAttackerEx( 0,0,1, MALGANIS     )
				CampaignAttackerEx(8, 8, 8, CommonAi.GARGOYLE);//call CampaignAttackerEx( 8,8,8, GARGOYLE     )
		...
		private void main() {//function main takes nothing returns nothing
			...
			SetBuildUnitEx(0, 0, 8, CommonAi.ZIGGURAT_2);//call SetBuildUnitEx( 0,0,8, ZIGGURAT_2		)
			...
			CampaignDefenderEx(1, 1, 0, CommonAi.GARGOYLE);//call CampaignDefenderEx( 1,1,0, GARGOYLE	)
			CampaignDefenderEx(0, 0, 1, CommonAi.CRYPT_FIEND);//call CampaignDefenderEx( 0,0,1, CRYPT_FIEND	)
			CampaignDefenderEx(0, 0, 1, CommonAi.MALGANIS);//call CampaignDefenderEx( 0,0,1, MALGANIS	)
			...
			//
			InitAssaultGroup();//call InitAssaultGroup()
			CampaignAttackerEx(2, 2, 12, CommonAi.GHOUL);//call CampaignAttackerEx( 2,2,12, GHOUL       )
			...
			//
			InitAssaultGroup();//call InitAssaultGroup()
			CampaignAttackerEx(3, 3, 2, CommonAi.CRYPT_FIEND);//call CampaignAttackerEx( 3,3,2, CRYPT_FIEND  )
