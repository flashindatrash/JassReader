	...
	public class N05x09Ai {
		...
		private void after_quest() {//function after_quest takes nothing returns nothing
			...
			while (true) {//loop
				...
				CampaignAttackerEx(1, 1, 4, CommonAi.NAGA_SIREN);//call CampaignAttackerEx( 1, 1, 4, NAGA_SIREN    )
				CampaignAttackerEx(0, 0, 1, CommonAi.NAGA_VASHJ);//call CampaignAttackerEx( 0, 0, 1, NAGA_VASHJ	)
		...
		private void main() {//function main takes nothing returns nothing
			...
			CampaignDefenderEx(0, 1, 2, CommonAi.NAGA_MYRMIDON);//call CampaignDefenderEx( 0, 1, 2, NAGA_MYRMIDON )
			...
			while (true) {//loop
				//
				InitAssaultGroup();//call InitAssaultGroup()
				CampaignAttackerEx(5, 5, 3, CommonAi.NAGA_REAVER);//call CampaignAttackerEx( 5, 5, 3, NAGA_REAVER	)
				...
				//
				InitAssaultGroup();//call InitAssaultGroup()
				CampaignAttackerEx(5, 5, 5, CommonAi.NAGA_REAVER);//call CampaignAttackerEx( 5, 5, 5, NAGA_REAVER   )
				CampaignAttackerEx(0, 0, 2, CommonAi.NAGA_SIREN);//call CampaignAttackerEx( 0, 0, 2, NAGA_SIREN    )
				CampaignAttackerEx(1, 1, 1, CommonAi.NAGA_VASHJ);//call CampaignAttackerEx( 1, 1, 1, NAGA_VASHJ	)
