...
namespace Jass {
	...
	public class H05x06Ai {
		...
		private void switch_to_akama() {//function switch_to_akama takes nothing returns nothing
			...
			SetBuildUpgrEx(1, 1, 1, CommonAi.UPG_ORC_WAR_DRUMS);//call SetBuildUpgrEx( 1,1,1, UPG_ORC_WAR_DRUMS   )
			SetBuildUpgrEx(1, 1, 1, CommonAi.UPG_ORC_BERSERK);//call SetBuildUpgrEx( 1,1,1, UPG_ORC_BERSERK     )
			SetBuildUpgrEx(2, 2, 3, CommonAi.UPG_ORC_ARMOR);//call SetBuildUpgrEx( 2,2,3, UPG_ORC_ARMOR       )
			SetBuildUpgrEx(2, 2, 3, CommonAi.UPG_ORC_MELEE);//call SetBuildUpgrEx( 2,2,3, UPG_ORC_MELEE       )
		}//endfunction
		//
		//
		//
		private void main() {//function main takes nothing returns nothing
			CampaignAI(CommonAi.CHAOS_BURROW, null);//call CampaignAI(CHAOS_BURROW,null)
			...
			SetBuildUnitEx(1, 1, 1, CommonAi.CHAOS_PEON);//call SetBuildUnitEx( 1,1,1, CHAOS_PEON      )
			SetBuildUnitEx(0, 0, 2, CommonAi.ORC_BARRACKS);//call SetBuildUnitEx( 0,0,2, ORC_BARRACKS    )
			SetBuildUnitEx(0, 0, 5, CommonAi.CHAOS_BURROW);//call SetBuildUnitEx( 0,0,5, CHAOS_BURROW    )
			SetBuildUnitEx(0, 0, 1, CommonAi.FORGE);//call SetBuildUnitEx( 0,0,1, FORGE           )
			SetBuildUnitEx(8, 8, 8, CommonAi.CHAOS_PEON);//call SetBuildUnitEx( 8,8,8, CHAOS_PEON      )
			SetBuildUnitEx(0, 0, 1, CommonAi.STRONGHOLD);//call SetBuildUnitEx( 0,0,1, STRONGHOLD      )
			SetBuildUnitEx(0, 0, 2, CommonAi.BESTIARY);//call SetBuildUnitEx( 0,0,2, BESTIARY        )
			SetBuildUnitEx(0, 0, 2, CommonAi.LODGE);//call SetBuildUnitEx( 0,0,2, LODGE           )
			CampaignDefenderEx(1, 1, 2, CommonAi.CHAOS_GRUNT);//call CampaignDefenderEx( 1,1,2, CHAOS_GRUNT         )
			CampaignDefenderEx(0, 0, 2, CommonAi.CHAOS_WARLOCK);//call CampaignDefenderEx( 0,0,2, CHAOS_WARLOCK       )
			CampaignDefenderEx(1, 1, 1, CommonAi.CHAOS_RAIDER);//call CampaignDefenderEx( 1,1,1, CHAOS_RAIDER        )
			CampaignDefenderEx(0, 0, 1, CommonAi.CHAOS_BLADEMASTER);//call CampaignDefenderEx( 0,0,1, CHAOS_BLADEMASTER   )
			CampaignDefenderEx(0, 0, 2, CommonAi.ORC_DRAGON);//call CampaignDefenderEx( 0,0,2, ORC_DRAGON          )
			SetBuildUpgrEx(1, 1, 1, CommonAi.UPG_ORC_BURROWS);//call SetBuildUpgrEx( 1,1,1, UPG_ORC_BURROWS     )
			...
			SuicideOnPlayer(CommonAi.M2, N07x04Ai.targ);//call SuicideOnPlayer(M2,targ)
			//
			InitAssaultGroup();//call InitAssaultGroup()
			...
			SuicideOnPlayerEx(CommonAi.M6, CommonAi.M6, CommonAi.M5, N07x04Ai.targ);//call SuicideOnPlayerEx(M6,M6,M5,targ)
			//
			InitAssaultGroup();//call InitAssaultGroup()
			...
			SuicideOnPlayerEx(CommonAi.M7, CommonAi.M7, CommonAi.M6, N07x04Ai.targ);//call SuicideOnPlayerEx(M7,M7,M6,targ)
			...
			CampaignAttackerEx(1, 1, 1, CommonAi.CHAOS_BLADEMASTER);//call CampaignAttackerEx( 1,1,1, CHAOS_BLADEMASTER)
			SuicideOnPlayerEx(CommonAi.M6, CommonAi.M6, CommonAi.M5, N07x04Ai.targ);//call SuicideOnPlayerEx(M6,M6,M5,targ)
			SetBuildUpgrEx(0, 0, 1, CommonAi.UPG_ORC_WAR_DRUMS);//call SetBuildUpgrEx( 0,0,1, UPG_ORC_WAR_DRUMS   )
			//
			InitAssaultGroup();//call InitAssaultGroup()
			...
			CampaignAttackerEx(1, 1, 2, CommonAi.CHAOS_WARLOCK);//call CampaignAttackerEx( 1,1,2, CHAOS_WARLOCK   )
			SuicideOnPlayerEx(CommonAi.M7, CommonAi.M7, CommonAi.M6, N07x04Ai.targ);//call SuicideOnPlayerEx(M7,M7,M6,targ)
			SetBuildUpgrEx(1, 1, 3, CommonAi.UPG_ORC_ARMOR);//call SetBuildUpgrEx( 1,1,3, UPG_ORC_ARMOR       )
			SetBuildUpgrEx(1, 1, 3, CommonAi.UPG_ORC_MELEE);//call SetBuildUpgrEx( 1,1,3, UPG_ORC_MELEE       )
			//
			InitAssaultGroup();//call InitAssaultGroup()
			CampaignAttackerEx(3, 3, 4, CommonAi.CHAOS_GRUNT);//call CampaignAttackerEx( 3,3,4, CHAOS_GRUNT     )
