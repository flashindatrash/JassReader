...
namespace Jass {
	...
	public class N02x01Ai {
		...
		private void main() {//function main takes nothing returns nothing
			...
			SetBuildUnitEx(8, 8, 8, CommonAi.NAGA_SLAVE);//call SetBuildUnitEx( 8, 8, 8, NAGA_SLAVE    )
			CampaignDefenderEx(0, 0, 2, CommonAi.NAGA_SNAP_DRAGON);//call CampaignDefenderEx( 0, 0, 2, NAGA_SNAP_DRAGON  )
			...
			//
			InitAssaultGroup();//call InitAssaultGroup()
			CampaignAttackerEx(2, 2, 4, CommonAi.NAGA_REAVER);//call CampaignAttackerEx( 2, 2, 4, NAGA_REAVER		)
			...
			while (true) {//loop
				...
				CampaignAttackerEx(1, 1, 3, CommonAi.NAGA_SNAP_DRAGON);//call CampaignAttackerEx( 1, 1, 3, NAGA_SNAP_DRAGON  )
				SuicideOnPlayerEx(CommonAi.M8, CommonAi.M8, CommonAi.M4, U08_tealAi.user);//call SuicideOnPlayerEx(M8,M8,M4,user)
				InitAssaultGroup();//call InitAssaultGroup()
				CampaignAttackerEx(1, 1, 2, CommonAi.NAGA_SIREN);//call CampaignAttackerEx( 1, 1, 2, NAGA_SIREN		)
				CampaignAttackerEx(2, 2, 4, CommonAi.NAGA_REAVER);//call CampaignAttackerEx( 2, 2, 4, NAGA_REAVER		)
				CampaignAttackerEx(3, 3, 6, CommonAi.NAGA_SNAP_DRAGON);//call CampaignAttackerEx( 3, 3, 6, NAGA_SNAP_DRAGON  )
				SuicideOnPlayerEx(CommonAi.M8, CommonAi.M8, CommonAi.M4, U08_tealAi.user);//call SuicideOnPlayerEx(M8,M8,M4,user)
			}//endloop
		}//endfunction
